    ...
    <View style={homeStyles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={homeStyles.finderCardsContainer}>
          <TouchableOpacity style={homeStyles.finderCard}>
          ...
          >
            <View style={homeStyles.featuredContent}>
              <View style={homeStyles.featuredLeft}>
                ...
                <TouchableOpacity style={homeStyles.cookNowButton}>
              ...
              <View style={homeStyles.streakContainer}>
                ...
                <View style={homeStyles.streakProgress}>
                  <View style={homeStyles.streakCircle}>
