    ...
    <View style={plannerStyles.container}>
      ...
      <View style={plannerStyles.preferencesContainer}>
        <TouchableOpacity style={plannerStyles.preferenceCard}>
          <Apple size={24} color="#FF6A00" />
          <Text style={plannerStyles.preferenceText}>Food Preferences</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={plannerStyles.preferenceCard}>
          <AlertCircle size={24} color="#FF6A00" />
          <Text style={plannerStyles.preferenceText}>Food Restrictions</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={plannerStyles.preferenceCard}>
          <Pizza size={24} color="#FF6A00" />
          <Text style={plannerStyles.preferenceText}>Favorite Cuisines</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={plannerStyles.mealPlansSection}>
        ...
        <View style={plannerStyles.mealCard}>
          ...
          <View style={plannerStyles.nutritionContainer}>
            ...
            <TouchableOpacity style={plannerStyles.recipeButton}>
